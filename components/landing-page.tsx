  ...
  return (
    <section className="py-20 px-4 bg-black">
      <div className="container mx-auto text-center">
        <h1 className="text-5xl font-bold mb-6">Welcome to API Lexica</h1>
        <p className="text-xl mb-10 text-gray-400 max-w-2xl mx-auto">
          Discover and integrate powerful APIs to supercharge your projects.
          Streamline your development process with our curated collection of
